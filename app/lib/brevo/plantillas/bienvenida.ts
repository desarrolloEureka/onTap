...
<html lang="es">
    ...
    <body style="background-color: #e2e8f0;">
        <div style="max-width: 32rem; margin: 2.5rem auto; background-color: #ffffff; border-radius: 0.5rem; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);">
            <div style="background-color: #02AF9B; color: #ffffff; text-align: center; padding: 1rem; border-top-left-radius: 0.5rem; border-top-right-radius: 0.5rem;">
                <h1 style="font-size: 1.5rem; font-weight: bold;">¡Bienvenido a One Tap Individual</h1>
            </div>
            <div style="padding: 1.5rem;">
                ...
                <a href="${loginUrl}" style="margin-top: 1.5rem; display: inline-block; background-color: #02AF9B; color: #ffffff; padding: 0.5rem 1rem; border-radius: 0.5rem; text-decoration: none;">Iniciar Sesión</a>
            </div>
            <div style="text-align: center; padding: 1rem; color: #718096; font-size: 0.875rem; border-top: 1px solid #e2e8f0;">
                ...
                <p style="margin-top: 0.5rem;">© 2024 OneTap Individual. Todos los derechos reservados.</p>
            </div>
        </div>
    </body>
</html>
