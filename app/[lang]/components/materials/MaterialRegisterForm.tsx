  ...
  const columns: GridColDef[] = [
    {
      ...
      renderCell: (params) => (
        <Button
          style={{ color: "black" }}
          onClick={() => handleEditMaterial(params?.value)}
        >
          <EditIcon />
        </Button>
      ),
                      ...
                      <div className="tw-w-full tw-flex tw-justify-center tw-justify-items-center">
                        <div className="tw-w-[95%] tw-h-[95%] tw-flex tw-justify-center tw-justify-items-center">
                          <TextField
                            variant="standard"
                            label={
                              dictionary.dictionary?.backOffice.MaterialSku
                            }
                      ...
                      <div className="tw-w-full tw-flex tw-justify-center tw-justify-items-center">
                        <div className="tw-w-[95%] tw-h-[95%] tw-flex tw-justify-center tw-justify-items-center">
                          <TextField
                            variant="standard"
                            label={
                              dictionary.dictionary?.backOffice.MaterialName
                            }
                            InputProps={{
                              startAdornment: (
                                <InputAdornment position="start">
                      ...
                      <div className="tw-w-full tw-flex tw-justify-center tw-items-center">
                        <div className="tw-w-[95%] tw-h-[100%] tw-flex tw-flex-col tw-justify-center tw-items-center tw-mt-3">
                          <div className="tw-w-full -tw-mb-4">
                            <Typography
                              color={
                                stateMaterialError ? "#d32f2f" : "textSecondary"
                              }
                              display={"flow"}
                          ...
                          <div className="tw-w-[98%] tw-h-[70%] tw-flex tw-items-center">
                            <Select
                              ...
                              error={!!stateMaterialError}
                              onChange={(e) =>
                                setStateMaterial(e.target.value === "true")
                              }
                            >
