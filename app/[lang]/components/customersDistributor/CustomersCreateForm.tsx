          ...
          >
            <Container className="tw-bg-[#02AF9B] tw-shadow-m tw-rounded-2xl tw-w-full tw-flex tw-flex-col tw-justify-center tw-items-center tw-p-2">
              {step === 1 ? (
                ...
                <div className="tw-w-[95%] tw-h-[100%] tw-bg-white tw-shadow-m tw-rounded-2xl tw-py-3 tw-mt-8 tw-mb-1 tw-flex tw-flex-col tw-items-center overflow-y-auto tw-overflow-x-hidden">
                  <div className="tw-w-[90%] tw-h-[90%] tw-flex tw-flex-col tw-items-center tw-mx-32 tw-mt-4 tw-mb-5">
