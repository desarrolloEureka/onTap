  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Button
          style={{ color: "black" }}
          onClick={() => handleSeeDetail(params?.value)}
        >
          <VisibilityIcon />
        </Button>
      ),
  ...
  function CustomToolbar() {
    return (
      ...
      >
        ...
        <Box
          sx={{ width: "35%", paddingBottom: 3, paddingTop: 1, paddingLeft: 2 }}
        >
          <Typography
            variant="inherit"
            style={{
        ...
        <Box sx={{ display: "flex", alignItems: "center", paddingRight: 110 }}>
          <div
            style={{
              height: "100%",
              width: "50%",
      ...
      {seeDetail ? (
          ...
          {dataDetailUser && dataDetailUserTool && (
            <div className=" tw-mt-4 tw-shadow-m tw-rounded-2xl tw-h-[800px] tw-w-[99%] tw-flex tw-flex-col tw-justify-center tw-items-center">
              <div
                ...
                className="tw-flex tw-flex-col tw-justify-center tw-items-start"
              >
                <Button
                  style={{ height: "100%", width: "10%" }}
                  className="tw-flex tw-justify-start tw-items-start"
                  onClick={() => handleBack()}
                >
                  <ArrowBackIcon
                    sx={{ color: "black", fontSize: 39, paddingTop: 1.8 }}
                  />
                </Button>
              </div>
              ...
              <div
                ...
                className="tw-bg-white tw-shadow-m tw-rounded-2xl tw-mt-0 tw-mb-5 tw-flex tw-flex-col tw-justify-center tw-items-center "
              >
                <div
                  style={{ height: "33%", width: "97%" }}
                  className="tw-flex tw-justify-start tw-items-center"
                >
                  <div
                    style={{ height: "100%", width: "35%" }}
                    className="tw-flex tw-justify-start tw-items-end"
                  >
                ...
                >
                  ...
                  <div style={{ height: "100%", width: "63%" }} className="">
                    <Typography className=" tw-text-sm  tw-text-black tw-text-end">
                      Total Vistas:{" "}
                      {dataDetailUserTool ? dataDetailUserTool?.views : ""}
                    </Typography>
                  </div>
                </div>
              </div>
              ...
              <div
                ...
                className="tw-bg-white tw-shadow-m tw-rounded-2xl tw-mb-10"
              >
                <DataGrid
                  apiRef={apiRefDetail}
                  rows={
                    filteredDetail?.map((row: any, index: any) => ({
                      id: index,
                      ...row,
                    })) ?? []
                  }
        ...
        <div className=" tw-mt-4 tw-shadow-m tw-rounded-2xl tw-h-[800px] tw-w-[99%] tw-flex tw-flex-col tw-justify-center tw-items-center">
          <div
            ...
            className="tw-bg-white tw-shadow-m tw-rounded-2xl"
          >
            <DataGrid
              apiRef={apiRef}
              rows={query ?? []}
