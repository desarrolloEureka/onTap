...
const PendingPaymentReportsHook = ({ handlePayUser }: { handlePayUser: any }) => {
    ...
    useEffect(() => {
        const getquery = async () => {
            ...
            const reportDataFinal = reportData.map((doc: any) => {
                return {
                    id: doc.dni || 1,
            ...
            }).filter((user: any) => user?.idDistributor === data?.uid && user.userInvoice.status != 'PAID');
