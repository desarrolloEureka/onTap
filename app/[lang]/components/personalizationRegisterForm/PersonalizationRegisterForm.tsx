...
const PersonalizationRegisterForm = ({
  params: { lang },
}: {
  params: { lang: Locale };
}) => {
  ...
  const columns: GridColDef[] = [
    {
      ...
      renderCell: (params) => (
        <Button
          style={{ color: "black" }}
          onClick={() => handleEditCustomization(params?.value)}
        >
          <EditIcon />
        </Button>
      ),
                        ...
                        <div className="tw-w-[95%] tw-h-[100%] tw-flex tw-flex-col tw-justify-center tw-items-center tw-mt-3">
                          ...
                          <div className="tw-w-[98%] tw-h-[70%] tw-flex tw-items-center">
                            <Select
                              ...
                              error={!!stateCustomizationError}
                              onChange={(e) =>
                                setStateCustomization(e.target.value === "true")
                              }
                            >
                        ...
                        <div className="tw-w-[95%] tw-h-[100%] tw-flex tw-flex-col tw-justify-center tw-items-center tw-mt-3">
                          ...
                          <div className="tw-w-[98%] tw-h-[70%] tw-flex tw-items-center">
                            <Select
                              ...
                              onChange={(e) =>
                                filterDataArticles(e.target.value)
                              }
                            >
