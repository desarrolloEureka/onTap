export interface Dictionary {
  ...
  recoverPassword: {recoverpassword:string; mail:string; next:string;};
  recoveryCode:{nextCode:string; resendcode:string; code:string; enter_the_recovery_code_that_we_have_sent_to_your_email:string; recoverycode:string; }
