import { getReference, saveCategory, saveColors, saveCustomization, saveDistributor, saveMaterial, savePlans, saveProduct, updateCategory, updateColors, updateCustomization, updateDistributor, updateMaterial, updatePlans, updateProduct } from '@/firebase/Documents';
...
export const UpdateCustomizationQuerie = async (dataSave: any, idCustomization: any) => {
...
export const UpdateDistributortionQuerie = async (dataSave: any, idDistributor: any) => {
