      ...
      >
        {
          icon.name === 'www' ?
            <div className='tw-flex tw-items-start tw-flex-col'>
              ...
              <div>
                <Typography style={{ width: 65, textDecoration: 'none' }} className='tw-text-white tw-z-10 tw-text-xs tw-flex tw-items-center tw-justify-center tw-capitalize' color={'white'}>
                  {nameLabel && nameLabel.length > 9 ? nameLabel.substring(0, 7) + '...' : nameLabel}
                </Typography>
              </div>
            </div>
            :
