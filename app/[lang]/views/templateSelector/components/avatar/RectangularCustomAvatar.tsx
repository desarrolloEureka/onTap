    ...
    return (
        <div className={`tw-bg-[#396593] tw-shadow-[0_0px_10px_10px_rgba(0,0,0,0.3)] tw-relative tw-flex tw-flex-col tw-z-10 tw-items-center tw-w-[80%] ${isSmallScreenTwo ? 'tw-h-[180px]' : 'tw-h-[230px] '}  tw-rounded-xl tw-mt-5`}>
            ...
            <Box className=' tw-flex tw-flex-row tw-w-full tw-align-middle tw- tw-justify-center tw-items-center tw-mt-3'>
                <div className='tw-text-[#396593] tw-flex tw-justify-center tw-items-center tw-mr-2 tw-shadow-[0_0px_10px_10px_rgba(0,0,0,0.1)] tw-w-[250px] tw-h-[27px] tw-bg-white tw-rounded-xl tw-truncate tw-text-base'>
            ...
            <Box className=' tw-flex tw-flex-row tw-w-full tw-align-middle tw- tw-justify-center tw-items-center tw-mt-3'>
                <div className='tw-text-[#396593] tw-flex tw-justify-center tw-items-center tw-ml-2 tw-shadow-[0_0px_10px_10px_rgba(0,0,0,0.1)] tw-w-[250px] tw-h-[27px] tw-bg-white tw-rounded-xl tw-truncate  tw-text-base'>
                    <Typography style={{ fontSize: '1.15rem', lineHeight: '1.75rem' }}>
