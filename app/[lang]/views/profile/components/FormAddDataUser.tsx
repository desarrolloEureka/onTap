...
const FormAddDataUser = ({ isDetailOpen, itemDetail, handleSeeMore, isProUser, dictionary }: { isDetailOpen: boolean, itemDetail: number, handleSeeMore: (numItem: number) => void; isProUser: boolean; dictionary: Dictionary }) => {
    return (
                                ...
                                <div className='tw-h-[40%] tw-w-[100%]  tw-flex tw-items-center tw-justify-center'>
                                    <div className='tw-h-[100%] tw-w-[70%] tw-flex tw-flex-col'>
                                        <FormControl variant="standard" sx={{ m: 1, mt: 1, width: '25ch' }}>
                                            ...
                                            <Input
                                                id="standard-adornment-weight"
                                                startAdornment={<><SchoolOutlinedIcon
                                                    style={{
                                                        color: '#62AD9B',
                                                        fontSize: '1.8rem',
                                                        marginRight: '0.5rem',
                                                ...
                                                />
                                                    ...
                                                    />
                                                    <span style={{ fontSize: '0.8rem', marginRight: '0.5rem' }}>{dictionary?.perfilView.labelTitle}: </span>
                                                </>
                                                }
                                                aria-describedby="standard-weight-helper-text"
                                                inputProps={{
                                            ...
                                            <Input
                                                ...
                                                startAdornment={
                                                    <>
                                                        ...
                                                        />
                                                        <span style={{ fontSize: '0.8rem', marginRight: '0.5rem' }}>{dictionary?.perfilView.labelInstitute}: </span>
                                                    </>
                                                }
                                                aria-describedby="standard-weight-helper-text"
                                                inputProps={{
                                            ...
                                            <Input
                                                ...
                                                startAdornment={
                                                    <>
                                                        ...
                                                        />
                                                        <span style={{ fontSize: '0.8rem', marginRight: '0.5rem' }}>{dictionary?.perfilView.labelYear}: </span>
                                                    </>
                                                }
                                                aria-describedby="standard-weight-helper-text"
                                                inputProps={{
                                            ...
                                            />
                                            <FormHelperText id="standard-weight-helper-text">{dictionary?.perfilView.labelEducation}</FormHelperText>
                                        </FormControl>
                                    </div>
                                    <div className='tw-h-[100%] tw-w-[20%] tw-flex tw-flex-col tw-items-center tw-justify-center'>
                                        <CustomSwitchGeneral />
                                        ...
                                        <FormControl variant="standard" sx={{ m: 1, mt: 1, width: '25ch' }}>
                                            ...
                                            <Input
                                                ...
                                                />
                                                    ...
                                                    />
                                                    <span style={{ fontSize: '0.8rem', marginRight: '0.5rem' }}>{dictionary?.perfilView.labelCompany}: </span>
                                                </>
                                                }
                                                aria-describedby="standard-weight-helper-text"
                                                inputProps={{
                                            ...
                                            <Input
                                                ...
                                                startAdornment={
                                                    <>
                                                        ...
                                                        />
                                                        <span style={{ fontSize: '0.8rem', marginRight: '0.5rem' }}>{dictionary?.perfilView.labelPosition}: </span>
                                                    </>
                                                }
                                                aria-describedby="standard-weight-helper-text"
                                                inputProps={{
                                            ...
                                            <Input
                                                ...
                                                startAdornment={
                                                    <>
                                                        ...
                                                        />
                                                        <span style={{ fontSize: '0.8rem', marginRight: '0.5rem' }}>{dictionary?.perfilView.labelStartDate}: </span>
                                                    </>
                                                }
                                                aria-describedby="standard-weight-helper-text"
                                                inputProps={{
                                            ...
                                            <Input
                                                ...
                                                startAdornment={
                                                    <>
                                                        ...
                                                        />
                                                        <span style={{ fontSize: '0.8rem', marginRight: '0.9rem' }}>{dictionary?.perfilView.labelEndDate}: </span>
                                                    </>
                                                }
                                                aria-describedby="standard-weight-helper-text"
                                                inputProps={{
                                            ...
                                            />
                                            <FormHelperText id="standard-weight-helper-text">{dictionary?.perfilView.labelCareerPath}</FormHelperText>
                                        </FormControl>
                                    </div>
                                    <div className='tw-h-[100%] tw-w-[20%] tw-flex tw-flex-col tw-items-center tw-justify-center'>
                                        <CustomSwitchGeneral />
                                            ...
                                            <Input
                                                ...
                                                startAdornment={
                                                    <>
                                                        ...
                                                        />
                                                        <span style={{ fontSize: '0.8rem', marginRight: '0.5rem' }}>{dictionary?.perfilView.labelEndDate}: </span>
                                                    </>
                                                }
                                                aria-describedby="standard-weight-helper-text"
                                                inputProps={{
